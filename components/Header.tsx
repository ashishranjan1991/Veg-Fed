    ...
    <header role="banner" className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 h-16 flex items-center justify-between px-4 md:px-8 z-10 sticky top-0 transition-colors duration-300">
      ...
      <div className="hidden sm:flex flex-1 max-w-sm md:max-w-md mx-4 md:mx-8 relative group">
        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          <i className="fa-solid fa-magnifying-glass text-gray-400 group-focus-within:text-emerald-500 transition-colors" aria-hidden="true"></i>
        </div>
        <input 
          type="search" 
          placeholder="Search modules..."
          aria-label="Search through ERP modules"
